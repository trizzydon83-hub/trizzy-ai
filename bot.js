...
sock.ev.on('messages.upsert', async m => {
  ...
  // Load current pair codes from server.json or keep in memory if preferred
  let activePairCodes = JSON.parse(fs.readFileSync('./activePairCodes.json', 'utf-8') || '{}');
  let miniPairCodes = JSON.parse(fs.readFileSync('./miniPairCodes.json', 'utf-8') || '{}');
